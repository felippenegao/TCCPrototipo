...
;(function( window ) {
  ...
  Memory.prototype.options = {
    ...
    cards : [
      {
        id : 1,
        img: "img/default/objects-01.svg"
      },
      {
        id : 2,
        img: "img/default/objects-02.svg"
      },
      {
        id : 3,
        img: "img/default/objects-03.svg"
      },
      {
        id : 4,
        img: "img/default/objects-04.svg"
      },
      {
        id : 5,
        img: "img/default/objects-05.svg"
      },
      {
        id : 6,
        img: "img/default/objects-06.svg"
      },
      {
        id : 7,
        img: "img/default/objects-07.svg"
      },
      {
        id : 8,
        img: "img/default/objects-08.svg"
      },
      {
        id : 9,
        img: "img/default/objects-09.svg"
      },
      {
        id : 10,
        img: "img/default/objects-10.svg"
      },
      {
        id : 11,
        img: "img/default/objects-11.svg"
      },
      {
        id : 12,
        img: "img/default/objects-12.svg"
      },
      {
        id : 13,
        img: "img/default/objects-13.svg"
      },
      {
        id : 14,
        img: "img/default/objects-14.svg"
      },
      {
        id : 15,
        img: "img/default/objects-15.svg"
      },
      {
        id : 16,
        img: "img/default/objects-16.svg"
      }
    ],
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameMetaHTML = '<div class="mg__meta--left">\
      <span class="mg__meta--level">Dificuldade: \
      <span id="mg__meta--level">' + this.chosenLevel + '</span>\
      </span>\
      <span class="mg__meta--moves">Movimentos: \
      <span id="mg__meta--moves">' + this.numMoves + '</span>\
      </span>\
      </div>\
      <div class="mg__meta--right">\
      <button id="mg__button--restart" class="mg__button">Voltar</button>\
      </div>';
    this.gameMeta.innerHTML = this.gameMetaHTML;
    this.game.appendChild(this.gameMeta);

    this.gameStartScreenHTML = '<h2 class="mg__start-screen--heading">Bem-vindo ao Jogo da Memória!</h2>\
      <p class="mg__start-screen--text">Forme os pares das imagens clicando nas cartas. Tente finalizar o jogo com o menor número de movimentos possíveis!</p>\
      <h3 class="mg__start-screen--sub-heading">Selecione a dificuldade</h3>\
      <ul class="mg__start-screen--level-select">\
      <li><span data-level="1">Fácil</span></li>\
      <li><span data-level="2">Média</span></li>\
      <li><span data-level="3">Difícil</span></li>\
      </ul>';
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      this._clearGame();
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">Parabéns!</h2>\
        <p class="mg__onend--message">Você ganhou com ' + this.numMoves + ' movimentos!</p>\
        <button id="mg__onend--restart" class="mg__button">Jogar novamente</button>';
