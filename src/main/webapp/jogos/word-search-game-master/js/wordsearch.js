(function () {
    ...
    var words = ['Avestruz', 'Águia', 'Burro', 'Borboleta',
        'Cachorro', 'Cabra', 'Carneiro', 'Camelo', 'Cobra',
        'Coelho', 'Cavalo', 'Elefante', 'Galo', 'Gato',
        'Jacaré', 'Leão', 'Macaco', 'Porco', 'Pavão', 'Peru',
    ...
    function raffleWords() {
        ...
        for (var i = 0; i < size; i++) {
            ...
            while (!condition) {
                ...
                if (vector.indexOf(words[index]) < 0) {
                    vector[i] = words[index];
                    condition = true;
                }
            }
        }
    ...
    WordSeach.prototype.lookup = function (selected) {
        ...
        if (this.settings.words.indexOf(words[0]) > -1 ||
            ...
            document.getElementById('ws-word-' + words[0]).className += ' ws-marked';
        }
    };
